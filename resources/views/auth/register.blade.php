    ...
    <div class="container">
        ...
        <div class="row justify-content-md-center my-5">
            <div class="col-md-auto">
                ...
                <p>Thank you for your interest in Best Indiakart.Please input following questionnaire to start business with
                    Best Indiakart.</p>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="input-group">
                                <label class="input-group-text col-md-4" for="userMethod">User Method *</label>
                                <select class="form-select" id="userType" name="userType" required="required">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-8">
                            <div class="input-group">
                                <label class="input-group-text col-md-4" for="email">E-mail *</label>
                                <input id="email" type="email" name="email" require class="form-control" placeholder="E-mail"
                                    aria-label="email" aria-describedby="basic-addon1" required="required"  value="{{ old('email') }}">
                            </div>
                            @error('email')
                    ...
                    <div class="row mb-3">
                        <div class="col-md-8">
                            <div class="input-group">
                                <label class="input-group-text col-md-4" for="userLoginUserId">Login UserID *</label>
                                <input id="userLoginUserId" type="text" name="userLoginUserId" require class="form-control"
                                    placeholder="Login UserID" aria-label="userLoginUserId" aria-describedby="basic-addon1" required="required" value="{{ old('userLoginUserId') }}">
                            </div>
                    ...
                    <div class="row align-items-center mb-3">
                        <div class="col-md-8">
                            <div class="input-group">
                                <label class="input-group-text col-md-4" for="password">Password *</label>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-8">
                            <div class="input-group">
                                <label class="input-group-text col-md-4" for="name">Name *</label>
                                <input id="name" name="name" type="text" require class="form-control" placeholder="Name"
                                    aria-label="name" aria-describedby="basic-addon1" required="required" value="{{ old('name') }}">
                            </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-8">
                            <div class="input-group">
                                <label class="input-group-text col-md-4" for="mobileno">Mobile Number *</label>
                                <input id="mobileno" name="mobileno" type="text" require required="required" class="form-control" placeholder="Mobile Number"
                                    aria-label="mobileno" aria-describedby="basic-addon1" value="{{ old('mobileno') }}">
                            </div>
                            @error('mobileno')
                    ...
                    <div class="row mb-3" id="userCompanydiv">
                        <div class="col-md-8">
                            <div class="input-group">
                                <label class="input-group-text col-md-4" for="userCompany">Company or Institution</label>
                                <input id="userCompany" name="userCompany" require type="text" class="form-control"
                    ...
                    <div class="row mb-3" id="userCompanyGSTdiv">
                        <div class="col-md-8">
                            <div class="input-group">
                                <label class="input-group-text col-md-4" for="userCompany">Company GST NO</label>
                                <input id="userCompanyGST" name="userCompanyGST" require type="text" class="form-control"
                                    placeholder="Company GST NO" aria-label="userCompanyGST"
        ...
        <style>
            .has-error { border: none !important; }
            label.error {
                margin-left: 1px;
                width: auto;
                display: block;
