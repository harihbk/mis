                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="input-group login-input-wrapper">
                                ...
                                <input required  id="txtemail" type="email" placeholder="Input your user ID or Email" name="email" class="login-input form-control">
                                @error('email')
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="input-group login-input-wrapper">
                                ...
                                <input required id="pwd" type="password" placeholder="Input your password" name="password" class="login-input form-control">
                                @error('password')
                                <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
