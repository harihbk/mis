    ...
    <div class="col-lg-12">
        <div id="inputFormRow">
            <div class="input-group mb-3">
                ...
                <input type="text" name="title[]" class="form-control m-input m-2" placeholder="Enter title" autocomplete="off">
                <input type="text" name="title_values[]" class="form-control m-input m-2" placeholder="Enter Values" autocomplete="off">
...
<script type="text/javascript">
    ...
    $("#addRow").click(function () {
        ...
        html += '<input type="text" name="title[]" class="form-control m-input m-2" placeholder="Enter title" autocomplete="off"><input type="text" name="title_values[]" class="form-control m-input m-2" placeholder="Enter Values" autocomplete="off">';
